...
bos_list = tweets[tweets['location'].str.contains("Boston|boston|bos|Bos")]['location']
tweets['location'].replace(bos_list, 'Boston, MA', inplace = True)
Cambridge_list = tweets[tweets['location'].str.contains("Cambridge|cambridge")]['location']
tweets['location'].replace(Cambridge_list, 'Cambridge, MA', inplace = True)
bos_list.count() + Cambridge_list.count()

other_list = tweets[tweets['location'].str.contains("MA|Massachusetts|Mass|Massachusetts|mass")]['location']
...
def parse_tweet(tweet):
  ...
  tweets2.to_csv('data/tweets2.csv')

tweets2['location'].sort_index()
bos_list2 = tweets2[tweets2['location'].str.contains("Boston|boston|bos|Bos")]['location']
tweets2['location'].replace(bos_list2, 'Boston, MA', inplace = True)
Cambridge_list2 = tweets2[tweets2['location'].str.contains("Cambridge|cambridge")]['location']
tweets2['location'].replace(Cambridge_list2, 'Cambridge, MA', inplace = True)
bos_list2.count() + Cambridge_list2.count()   
```
### Step 5
